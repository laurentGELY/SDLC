...
> **Version courante : v2.0+SDLC-30** · Un harnais de templates numérotés `01` → `12`, dont la plupart sont copiés dans un projet cible pour lui donner un cadre d'exécution complet.
